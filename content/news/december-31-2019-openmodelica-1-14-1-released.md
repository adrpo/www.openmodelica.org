...
---
**<span style="font-family: Arial, sans-serif; color: black; border: 1pt none windowtext; padding: 0in;">The OpenModelica 1.14.1 is now released.&nbsp;<br /> </span>******
...
Compared with [1.14.0][14], this release contains a fix for OMEdit crashes when editing dependent models in text mode and graphical mode.

 [14]: newss/199-december-6-2019-openmodelica-1-14-0-released
